...
class ControlDynamixel(OpenRTM_aist.DataFlowComponentBase):
	...
	def onActivated(self, ec_id):
		...
		print('Activate')
		# PortHandler初期化
		portHandler = PortHandler(self._DEVICENAME[0])
		print(self._DEVICENAME)
		# PacketHandler初期化
		...
		print('Activate')
                # トルクON
		dxl_comm_result, dxl_error = packetHandler.write1ByteTxRx(portHandler, self._DXL_ID, self._ADDR_MX_TORQUE_ENABLE, TORQUE_ENABLE)
